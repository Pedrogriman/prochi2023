...
import pandas as pd
from librerias_datos import leer_datos

def procesar_datos(leer_datos, all_predictions_by_comuna, metros_cuadrados_criterio, dormitorios_criterio, banos_criterio):
